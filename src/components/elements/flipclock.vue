...
export default {
	...
	mounted() {
		// Flipclock
		var FlipClock = require('flipclock-es6')
		var clock = $(this.$el).find('.money-2020-countdown').FlipClock(((new Date('3/13/2018') - new Date()) / 1000),{
...
.flip-clock-wrapper ul.play li.flip-clock-active .down {
  z-index: 2;
  -webkit-animation: turn 0.3s 0.5s linear both;
  -moz-animation: turn 0.3s 0.5s linear both;
  animation: turn 0.3s 0.5s linear both; }
...
.flip-clock-wrapper ul.play li.flip-clock-before .up {
  z-index: 2;
  -webkit-animation: turn2 0.5s cubic-bezier(.34,.13,.93,.24) both;
  -moz-animation: turn2 0.5s cubic-bezier(.34,.13,.93,.24) both;
  animation: turn2 0.5s cubic-bezier(.34,.13,.93,.24) both; }
...
.flip-clock-wrapper ul.play li.flip-clock-before .up .shadow {
  ...
  background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, rgba(0, 0, 0, 0.1)), color-stop(100%, rgba(0, 0, 0, 0.6)));
  background: linear, top, rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.6) 100%;
  ...
  background: linear, to bottom, rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.6) 100%;
